/**
 * Description: Heavy-light decomposition for range updates
 * Complexity: Query - O((logN)^2); Update - O((logN)^2)
 * Caution: SZ is the maximum number of vertices (in powers of 2)
 * Source: https://cp-algorithms.com/graph/hld.html
 */

template <class T, int SZ> struct HeavyLight {
  vector<vector<int>> g;
  LazySegTree<T, SZ> seg;
